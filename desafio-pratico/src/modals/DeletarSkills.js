...
export default function DeletarSkills({ show, handleClose, acao, id }) {
    ...
    return (
        <Modal style={{ marginTop: "9rem" }} show={show} onHide={handleClose}>
            ...
            <h3 style={{ fontSize: 17, padding: 20, color:"white", marginTop: "-1px" }}>Tem certeza que deseja deletar a Skill?</h3>
